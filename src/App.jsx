  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)' }}>
      ...
      >
        ...
        <PersonalDetails person={person} setter={setPerson} picturesetter={setSelectedFile} />
        ...
        <div className="page" id="download-pdf">
          ...
          <div className="side">
            ...
            <div>
              ...
              {languages.length !== 0 && <ResumeLanguages languages={languages} />}
            </div>
          </div>
